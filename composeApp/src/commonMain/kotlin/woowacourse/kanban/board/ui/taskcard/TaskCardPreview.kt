 ...
 */
private class CardPreviewParameterProvider : PreviewParameterProvider<TaskCardUiState> {
    override val values: Sequence<TaskCardUiState> = sequenceOf(
        TaskCardUiState(
...
private fun TaskCardPreview(
    @PreviewParameter(CardPreviewParameterProvider::class) taskCardUiState: TaskCardUiState,
) {
    TaskCard(
